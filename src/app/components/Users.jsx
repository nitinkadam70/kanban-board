...
const Users = () => {
  return (
    <div className="flex -space-x-4 w-fit rtl:space-x-reverse relative">
      {users.map((user, idx) => (
        <div key={idx} className="group relative">
          ...
          {/* Hover Popup */}
          <div className="absolute left-0 mt-2 z-10 hidden group-hover:flex items-center gap-2 bg-white dark:bg-gray-800 p-2 rounded-lg shadow-lg w-max">
            <img
